  ...
  if (Meteor.is_server) {
    ...
    var rules = {
      insert: function(userId) {
        return true;
        return Groups.isUserInGroup(userId, 'groupInsert');
      },
      update: function(userId) {
        return true;
        return Groups.isUserInGroup(userId, 'groupUpdate');
      },
      remove: function(userId) {
        return true;
        return Groups.isUserInGroup(userId, 'groupRemove');
      }
    };
    ...
    Meteor.publish('groups', function() {
      if (self.isUserInGroup(this.userId(), 'groupView'))
